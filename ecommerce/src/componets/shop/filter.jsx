        ...
        <div className="col-span-1 bg-white px-4 pb-6 shadow rounded overflow-hiddenb hidden md:block">
          <div className="divide-y divide-gray-200 space-y-5">
            ...
            <div className="pt-4">
              ...
              <div className="grid grid-cols-5 md:grid-cols-5 justify-center text-center gap-2">
                {/* Size selectors */}
                {sizes.map((item) => (
                  <div key={item.id} className="size-selector">
                    ...
                    <label
                      ...
                      className="text-xs border border-gray-200 rounded-sm flex items-center justify-center cursor-pointer shadow-sm text-gray-600"
                    >
